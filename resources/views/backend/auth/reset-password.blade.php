                                            ...
                                            <div class="row m-0">
                                                <div class="col-md-12 px-4 py-3">
                                                    <form method="POST" action="{{ route('password.update') }}">
                                                        @csrf
                                                        <h4 class="mb-2 card-title text-center">Reset Password</h4>
                                                    <p class="card-text mb-3">Please verify your email address and enter your new </br> password and confirm password.</p>
