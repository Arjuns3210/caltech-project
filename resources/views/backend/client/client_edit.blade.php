            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-content">
                        <div class="card-header">
                            <div class="row">
                                <div class="col-12 col-sm-7">
                                    ...
                                    <h5 class="pt-2">Edit Client :  {{$data['data']->company_name}}</h5>
                                </div>
                        ...
                        <!-- <hr class="mb-0"> -->
                    	<div class="card-body">
                            <form id="editClientData" method="post" action="saveClient?id={{$data['data']->id}}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <input class="form-control required" type="text" id="contact_person_name" name="contact_person_name" value="{{$data['data']->contact_person_name}}"><br/>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="row">
                                            <div class="col-sm-12">
                                            ...
                                            <div class="col-sm-12 company_number_section">
                                                <input class="form-control required" type="text" id="company_number" name="company_number" value="{{$data['data']->company_number}}"><br/>
                                            </div>
                                        </div><br>
                                    </div>
                                    <div class="col-sm-6">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        ...
                                        <input class="form-control required" type="text" id="country" name="country" value="{{$data['data']->country}}"><br/>
                                    </div>
                                     <div class="col-sm-6">
                                        <label for="state">State<span class="text-danger">*</span></label>
                                        <input class="form-control required" type="text" id="state" name="state" value="{{$data['data']->state}}"><br/>
                                    </div>
                                     <div class="col-sm-6">
                                        <label for="city">City<span class="text-danger">*</span></label>
                                        <input class="form-control required" type="text" id="city" name="city" value="{{$data['data']->city}}"><br/>
                                    </div>

                                    <div class="col-sm-6">
                                        <label for="pin_code">Pin Code<span class="text-danger">*</span></label>
                                        <input class="form-control required" type="text" id="pin_code" name="pin_code" value="{{$data['data']->pin_code}}"><br/>
                                    </div>

                                    <div class="col-sm-6">
                                        <label for="GSTIN">GSTIN<span class="text-danger">*</span></label>
                                        <input class="form-control required" type="text" id="GSTIN" name="GSTIN" value="{{$data['data']->GSTIN}}"><br/>
                                    </div>
                                    <div class="col-sm-6">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="pull-right">
                                            <button type="button" class="btn btn-success" onclick="submitForm('editClientData','post')">Update</button>
...
<script >
        $(function () {
            ...
            var phone = document.getElementById('company_number').value;

            $('#company_number').val(code+' '+phone);
